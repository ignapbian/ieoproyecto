	  ...
	  <table class="table table-striped table-sm">
	  	<tbody>
		    ...
		    <div class="trans text-center">
		      ...
		      <button type="submit" class="btn btn-primary" name="Cancelar" id="Cancelar">Guardar</button>
		      <button type="submit" class="btn btn-outline-primary" name="Cancelar" id="Cancelar">Continuar</button>		 
		  	</div>         
		    </td>
		 </tr>	
	  	</tbody>
